...
public class AnnouncementService {
    ...
    public Mono<Void> initiateSubscription(UUID announcementId, UUID deliveryPersonId) {
        return Mono.fromRunnable(() -> {
            com.polytechnique.tiibntick.infrastructure.kafka.event.SubscriptionAttemptEvent event = new com.polytechnique.tiibntick.infrastructure.kafka.event.SubscriptionAttemptEvent(
                    announcementId,
                    deliveryPersonId,
                    Instant.now());
