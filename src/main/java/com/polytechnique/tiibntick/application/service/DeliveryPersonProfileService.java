...
import com.polytechnique.tiibntick.domain.model.enums.logistics.LogisticsClass;
import com.polytechnique.tiibntick.domain.model.enums.logistics.LogisticsType;
    ...
    private Mono<Void> updateAddressFields(UUID personId, DeliveryPersonUpdateRequest request) {
        ...
        return personAddressRepository.findByPersonId(personId)
                ...
                .flatMap(address -> {
                    ...
                    if (changed) {
                        // Use map to keep a non-empty signal so switchIfEmpty is not triggered
                        return modificationAddressService.updateAddress(address).thenReturn(true);
                    }
                ...
                .switchIfEmpty(
                        Mono.defer(() -> {
                            ...
                            newAddress.setType(com.polytechnique.tiibntick.domain.model.enums.address.AddressType.PRIMARY);
                            ...
                            return creationAddressService.createAddress(newAddress)
                                    .flatMap(savedAddress -> {
                                        ...
                                        return personAddressRepository.save(pa).thenReturn(true);
                                    });
                        }))
                .then();
    }
