...
public class AdminDeliveryPersonService {
    ...
    private final com.polytechnique.tiibntick.infrastructure.persistence.repository.LogisticsRepository logisticsRepository;
    private final com.polytechnique.tiibntick.infrastructure.persistence.repository.DeliveryPersonRepository deliveryPersonRepository;
    ...
    public reactor.core.publisher.Flux<DeliveryPersonDetailsResponse> getAllDeliveryPersons(
        ...
        reactor.core.publisher.Flux<com.polytechnique.tiibntick.domain.model.DeliveryPerson> deliveryPersons;
        if (status != null) {
    ...
    private DeliveryPersonDetailsResponse mapToDetailsResponse(com.polytechnique.tiibntick.domain.model.DeliveryPerson dp,
            com.polytechnique.tiibntick.domain.model.Person person, com.polytechnique.tiibntick.domain.model.Logistics logistics) {
