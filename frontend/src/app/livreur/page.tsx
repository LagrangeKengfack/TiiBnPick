...
export default function LivreurDashboard() {
  ...
  const handleToggleAvailability = () => {
    ...
    toast({
      title: isOnline ? 'Mode hors ligne' : 'Mode en ligne',
      description: isOnline ? 'Vous ne recevrez plus de nouvelles commandes' : 'Vous êtes maintenant disponible pour les livraisons',
    })
  }
  ...
  const handleAcceptDelivery = (deliveryId: string) => {
    toast({
      ...
      description: `Livraison ${deliveryId} ajoutée à votre liste`,
    })
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-4">
              ...
              >
                <div className={cn("w-2 h-2 rounded-full mr-2", isOnline ? "bg-white" : "bg-gray-400")} />
            ...
            <div className="md:hidden flex items-center gap-2">
              <Button
                ...
                className={cn(
                  ...
                  isOnline ? "bg-green-500" : "border-gray-300 text-gray-600"
                )}
              >
                <div className={cn("w-2 h-2 rounded-full mr-1", isOnline ? "bg-white" : "bg-gray-400")} />
                {isOnline ? 'En ligne' : 'Hors ligne'}
              </Button>
              ...
              <Card className="bg-gradient-to-r from-orange-500 to-amber-500 text-white overflow-hidden">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm opacity-90">
                        {isOnline ? 'Vous êtes en ligne et disponible' : 'Vous êtes hors ligne'}
                      </p>
                    </div>
                  ...
                  <div className="mt-4 flex gap-3">
                    ...
                    >
                      <div className={cn("w-2 h-2 rounded-full mr-2", isOnline ? "bg-green-400" : "bg-gray-400")} />
